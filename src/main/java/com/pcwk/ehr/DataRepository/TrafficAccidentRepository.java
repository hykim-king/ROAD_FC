 ...
 * 
 * public interface TrafficAccidentRepository extends
 * JpaRepository<TrafficAccident, Long>,
 * JpaSpecificationExecutor<TrafficAccident>{
 * 
 *//**
	 * 연도 목록 조회
	 */
 ...
 * "AND (:timezone IS NULL OR c.taTimeZone = :timezone)") List<TrafficAccident>
 * findByFilter(@Param("year") Integer year,
 * 
