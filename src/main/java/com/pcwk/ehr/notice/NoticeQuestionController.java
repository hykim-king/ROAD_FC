...
import com.pcwk.ehr.notice.NoticeAnswerForm;
...
public class NoticeQuestionController {
	...
	private final String uploadDir = "C:/Users/82109/Desktop/JAP_20240909/04_SPRING/boot/workspace/project_oracle/src/main/resources/static/img/notice/";  // 이미지 저장할 경로 설정
	
	@PreAuthorize("isAuthenticated")
	@PostMapping("/create")
	public String questionCreate(@Valid NoticeQuestionForm questionForm,BindingResult bindingResult,Principal principal) throws IllegalStateException, IOException {
	...
	public String questionModify(@Valid NoticeQuestionForm questionForm, BindingResult bindingResult, 
		...
		NoticeQuestion outQuestion = service.modify(question, questionForm.getSubject(), questionForm.getContent(), savedFilePaths);
