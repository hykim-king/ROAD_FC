              ...
              <div class="body"> 
                  ...
                  <div class="desc">                                           
                    <p>국가교통정보센터(LIVE) 제공</p>
                      <div class="close" onclick="closeCctvOverlay()" title="닫기">닫기</div> 
                  </div> 
              </div> 
          </div>`;
      ...
      overlayContent.innerHTML = `
            <div class="info"> 
                ...
                <div class="body"> 
                    ...
                    <div class="desc">                                           
                      <p>국가교통정보센터(LIVE) 제공</p>
                        <div class="close" onclick="closeTunnelOverlay()" title="닫기">닫기</div> 
                    </div> 
                </div> 
            </div>`;
...
/*  function showAccidentMarkers() {
  ...
  function showCctvMarkers() {
    ...
    tunnelMarkers.forEach(function(marker) {
      marker.setMap(null);
    });
    tunnelMarkers = [];
  ...
  function showTunnelMarkers() {
    window.activeMode = 'tunnel';
...
/*  safetyIndex.forEach(function(safety) {
    ...
    var content = document.createElement("div");
    content.className = 'safety-overlay';
    content.innerHTML = `
           <div class="safetyIndex">
             <div>
               ${safety.safetyIndex ? `<div class="safetyScore">${safety.safetyIndex}</div>` : ''}
             </div>
           </div>
