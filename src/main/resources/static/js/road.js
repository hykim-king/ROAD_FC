kakao.maps.load(function() {
  ...
  var safetyMarkerImageSafe = new kakao.maps.MarkerImage(safetyImageSafeSrc, imageSize);
  var safetyMarkerImageCaution = new kakao.maps.MarkerImage(safetyImageCautionSrc, imageSize);
  var safetyMarkerImageDanger = new kakao.maps.MarkerImage(safetyImageDangerSrc, imageSize);
  //---------------안전지수--------------------------
  ...
  function showSafetyMarkers(region) {
    safetyMarkers.forEach(marker => marker.setMap(null));

    if (region !== "nationwide") {
      safetyMarkers.forEach(marker => marker.setMap(map));
    } else {
